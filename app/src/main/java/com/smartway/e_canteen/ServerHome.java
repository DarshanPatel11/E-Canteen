...
import com.smartway.e_canteen.ViewHolder.ServerMenuViewHolder;
...
public class ServerHome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtFullName.setText(ServerCommon.currentUser.getName());
    ...
    private void updateToken(String token) {
        ...
        tokens.child(ServerCommon.currentUser.getPhone()).setValue(data);
    }
        ...
        if (saveUri != null){
            ...
            imageFolder.putFile(saveUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(ServerHome.this, "Image Uploaded!!!", Toast.LENGTH_SHORT).show();
    ...
    private void loadMenu() {
        adapter = new FirebaseRecyclerAdapter<Category, ServerMenuViewHolder>(
                Category.class,
                R.layout.menu_item,
                ServerMenuViewHolder.class,
                categories
        ) {
            @Override
            protected void populateViewHolder(ServerMenuViewHolder viewHolder, Category model, int position) {
                viewHolder.txtMenuName.setText(model.getName());
                Picasso.with(ServerHome.this).load(model.getImage()).into(viewHolder.imageView);
                viewHolder.setItemClickListener(new ItemClickListener() {
                    @Override
                    public void OnClick(View view, int position, boolean isLongClicked) {
                        Intent foodList = new Intent(ServerHome.this, ServerFoodList.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        int id = item.getItemId();
        if (id == R.id.nav_menu) {
            startActivity(new Intent(ServerHome.this, ServerHome.class));

        } //else if (id == R.id.nav_cart) {
            //startActivity(new Intent(ServerHome.this, Cart.class));

        //}
        else if (id == R.id.nav_orders) {
            startActivity(new Intent(ServerHome.this, ServerOrderStatus.class));

        } else if (id == R.id.nav_log_out) {

            startActivity(new Intent(ServerHome.this, MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
        }
