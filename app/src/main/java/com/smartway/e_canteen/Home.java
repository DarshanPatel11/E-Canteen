...
import com.smartway.e_canteen.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void updateToken(String token) {
        ...
        Token data = new Token(token, false); //false because token sent from client
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            Paper.book().destroy();
            startActivity(new Intent(Home.this, MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
        }
